...
const PrivacyPolicy = () => {
  return (
    ...
    <div >
    <Navigation />
      <div className="w-90 max-w-5xl font-medium-fgm border-white/[21%] bg-white/[9%] border-2 border-pink200 bg-opacity-90 p-6 lg:p-8 rounded-2xl shadow-lg shadow-pink200/30  mt-28 lg:mt-40 mx-auto  mb-5 lg:-mb-16">

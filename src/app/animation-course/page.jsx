  ...
  return (
    ...
    <main className="min-h-screen text-white">
      <div className="max-w-4xl mx-auto px-6 py-16 pt-28">
        <h1 className="font-primary text-2xl lg:text-4xl xl:text-5xl font-bold text-white mb-6">
          Animation Course — Learn <span className="bg-gradient-to-r from-purple to-pink200 bg-clip-text text-transparent">3D & 2D Animation</span>
        </h1>

  ...
  return (
    <div className=' mx-auto'>
    {
        showPolicy && (
            ...
            className=" w-1/2 fixed bottom-0  transform -translate-x-1/2 bg-gradient-to-r from-[#000]/30 to-[#F7009E]/30  text-white/70 p-4 lg:py-5 rounded-lg shadow-lg md:w-full z-[9999909999] ">

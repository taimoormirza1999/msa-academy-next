  ...
  return (
    <div className='w-full'>
    {
        showPolicy && (
            ...
            className=" fixed bottom-0  transform -translate-x-1/2 bg-gradient-to-r from-[#A400E8]/30 to-[#F7009E]/30  text-white/70 p-4 lg:py-5 rounded-lg shadow-lg w-full z-[99999099999] ">

...
const socials = [
  ...
  },
  {
    ...
    icon: <FaTiktok className="text-purple-400 text-2xl lg:text-3xl" />,
    name: "TikTok",
    desc: "Quick animation tips and clips",
  },
  {
    href: "https://www.facebook.com/MSAOfficial",
    icon: <FaFacebook className="text-blue-500 text-2xl lg:text-3xl" />,
    name: "Facebook",
    ...
    <main className="min-h-screen text-white relative overflow-hidden">
      ...
      <div className="w-[90%] max-w-5xl font-eastroman-trial-bold p-6 lg:p-8 mt-28 mx-auto mb-5 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-14">
          <div className="custom-border bg-black p-6 lg:p-8">
            <h2 className="font-primary text-lg lg:text-xl font-semibold text-white mb-2">General Inquiries</h2>
          ...
          <div className="custom-border bg-black p-6 lg:p-8">
            <h2 className="font-primary text-lg lg:text-xl font-semibold text-white mb-2">Partnerships & Business</h2>
            <p className="text-gray-50 text-sm mb-3">
        ...
        <div className="grid grid-cols-2 gap-4 mb-14">
          {socials.map((s, i) => (
            <a key={i} href={s.href} target="_blank" rel="noopener noreferrer" className="custom-border bg-black p-4 lg:p-5 flex items-center gap-3 lg:gap-4 hover:opacity-80 transition">
              {s.icon}
              <div>
                <p className="font-semibold text-white font-primary text-sm lg:text-base">{s.name}</p>
                <p className="text-gray-50 text-xs lg:text-sm">{s.desc}</p>
              </div>
            </a>
          ))}
        </div>

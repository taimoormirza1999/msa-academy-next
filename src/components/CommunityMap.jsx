    ...
    <div className="relative  mt-2 lg:mb-20 md:mb-24 md:-mt-24 bg-cover bg-center mx-auto">
      ...
      <div className="relative xl:pt-20 pb-10 flex flex-col items-center justify-center xl:min-h-screen z-10">
        ...
        <div className="text-center">
          <p className="text-gray-300 text-lg md:text-xl 4kl:text-5xl mt-2 md:w-4/5 font-primary mx-auto">
            Be a part of
          </p>
          ...
          <p className="text-gray-300 text-lg md:text-xl mt-1 md:w-4/5 font-primary mx-auto 4kl:text-5xl">
